...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    for path in from_person:
        ...
        if temp_counter > 0:
            ...
            # parsed_email = ' '.join([word for word in parsed_email.split(' ') if word != 'sara'])
            # parsed_email = ' '.join([word for word in parsed_email.split(' ') if word != 'shackleton'])
            # parsed_email = ' '.join([word for word in parsed_email.split(' ') if word != 'chris'])
            # parsed_email = ' '.join([word for word in parsed_email.split(' ') if word != 'germani'])
            # print parsed_email
